...
) ENGINE = InnoDB AUTO_INCREMENT = 288 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2027, '商品', 3, 1, '/system/product', 'C', '0', 'system:product:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '商品菜单');
INSERT INTO `sys_menu` VALUES (2028, '商品查询', 2027, 1, '#', 'F', '0', 'system:product:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2029, '商品新增', 2027, 2, '#', 'F', '0', 'system:product:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2030, '商品修改', 2027, 3, '#', 'F', '0', 'system:product:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2031, '商品删除', 2027, 4, '#', 'F', '0', 'system:product:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2033, '商品信息', 0, 4, '#', 'M', '0', '', 'fa fa-navicon', 'admin', '2019-12-04 09:10:29', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2034, '商品', 2033, 1, '/system/product', 'C', '0', 'system:product:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '商品菜单');
INSERT INTO `sys_menu` VALUES (2035, '商品查询', 2034, 1, '#', 'F', '0', 'system:product:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2036, '商品新增', 2034, 2, '#', 'F', '0', 'system:product:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2037, '商品修改', 2034, 3, '#', 'F', '0', 'system:product:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2038, '商品删除', 2034, 4, '#', 'F', '0', 'system:product:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 197 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', 'Seven', '00', '396691973@qq.com', '15903658019', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-12-04 09:03:20', 'admin', '2019-11-19 11:33:00', 'ry', '2019-12-04 09:03:20', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('619f31b3-7c0f-4cda-8153-5b18cb0b6ca6', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2019-12-04 08:55:07', '2019-12-04 09:00:52', 1800000);
INSERT INTO `sys_user_online` VALUES ('a187b9d3-03b1-4a92-b688-b99f45c2450e', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2019-12-04 09:03:15', '2019-12-04 09:11:57', 1800000);
...
CREATE TABLE `ums_member_login_log`  (
  ...
  `member_id` bigint(20) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录人的ip地址',
